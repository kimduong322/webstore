...
public class InMemoryOrderRepository implements OrderRepository {
	...
	private long saveAddress(Address shippingAddress) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("doorNo", shippingAddress.getDoorNo());
		params.put("streetName", shippingAddress.getStreetName());
		params.put("areaName", shippingAddress.getAreaName());
		params.put("state", shippingAddress.getState());
		params.put("country", shippingAddress.getCountry());
		params.put("zip", shippingAddress.getZipCode());

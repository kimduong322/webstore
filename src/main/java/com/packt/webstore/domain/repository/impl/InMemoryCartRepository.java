...
public class InMemoryCartRepository implements CartRepository {
	...
	public void create(CartDto cartDto) {
		...
		cartDto.getCartItems().stream().forEach(
				cartItemDto -> {
					...
					HashMap<String, Object> cartItemParams = new HashMap<String, Object>();
					cartItemParams.put("id", cartItemDto.getId());
					cartItemParams.put("productId", productById.getProductId());
					cartItemParams.put("cartId", cartDto.getId());
					cartItemParams.put("quantity", cartItemDto.getQuantity());
					
					jdbcTemplate.update(INSERT_CART_ITEM_SQL, cartItemParams);
				}
			);
	}

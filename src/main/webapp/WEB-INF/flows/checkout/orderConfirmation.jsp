			...
			<form:form modelAttribute="order" class="form-horizontal">
				...
				<div class="well col-xs-10 col-sm-10 col-md-6 colxs-offset-1 col-sm-offset-1 col-md-offset-3">
					...
					<div class="row">
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center textdanger">
										<h4>
											<strong style="color: red">$${order.cart.grandTotal}
											</strong>
										</h4>
									</td>
								</tr>
						...
						<button id="back" class="btn btn-default" name="_eventId_backToCollectShippingDetail">
						back
						</button>
